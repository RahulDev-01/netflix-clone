      ...
      <div className="relative w-full h-screen overflow-hidden">
        ...
        <div className="absolute bottom-[50px] left-0 p-8 text-white z-20 ml-[22px]">
          ...
          <div className='flex gap-[30px] mt-[20px]'>
            < button className='bg-white text-[25px] text-black px-[25px] py-[8px] rounded-[5px] flex items-center gap-[10px] cursor-pointer hover:bg-[#ffffffbf]'> <FaPlay  className='inline ' />Play</button>
            <button className='bg-[#6d6d6eb3] text-[25px] text-white px-[25px] py-[8px] rounded-[5px] flex items-center gap-[10px]   mb-[1px] cursor-pointer hover:bg-[#6d6d6e66]'><IoIosInformationCircleOutline className='inline' />More Info</button>
          </div>
        </div>
      </div>
    </>
